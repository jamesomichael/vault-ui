import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{r as l}from"./iframe-CNx1YsBh.js";import{F as s}from"./index-D5Rnx5Ou.js";import"./preload-helper-Dp1pzeXC.js";import"./index-CIMxt85o.js";import"./index-DjTUD-ya.js";import"./index-DBHgYti3.js";import"./index-sEqg-sIT.js";import"./index-DZ2scaSf.js";import"./iconBase-C4mFF_I3.js";const re={title:"Shared/Field",component:s,args:{type:"text",label:"Field"},parameters:{layout:"centered"}},n={},d={args:{type:"text",label:"Text Field Label",value:"Sample text",isEditable:!1}},i={render:e=>{const[t,a]=l.useState("Sample text");return o.jsx(s,{...e,type:"text",label:"Text Field Label",value:t,isEditable:!0,onChange:r=>a(r.target.value)})}},p={render:e=>{const[t,a]=l.useState("Sample text");return o.jsx(s,{...e,type:"text",label:"Text Field Label",value:t,isEditable:!0,canCopy:!0,onChange:r=>a(r.target.value)})}},u={args:{type:"text",label:"Text Field Label",value:"Sample text",isEditable:!1,shouldMask:!0}},c={render:e=>{const[t,a]=l.useState("p455w0rd123");return o.jsx(s,{...e,type:"text",label:"Password Field Label",value:t,isEditable:!1,isPassword:!0,shouldMask:!0,onPasswordGeneration:r=>a(r)})}},x={render:e=>{const[t,a]=l.useState("p455w0rd123");return o.jsx(s,{...e,type:"text",label:"Password Field Label",value:t,isEditable:!1,isPassword:!0,shouldMask:!0,canCopy:!0,onPasswordGeneration:r=>a(r)})}},m={args:{type:"text",label:"Link Field Label",value:"https://jamesmichael.dev/projects/vault",isEditable:!1,canCopy:!0,isUri:!0}},b={render:e=>{const[t,a]=l.useState(!0);return o.jsx(s,{...e,type:"checkbox",label:"Checkbox Field Label",value:t,isEditable:!0,onChange:()=>a(r=>!r)})}},g={args:{type:"dropdown",dropdownOptions:[{id:"1",label:"Option 1"},{id:"2",label:"Option 2"}],isEditable:!0}};var h,v,y;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:"{}",...(y=(v=n.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};var S,w,T;d.parameters={...d.parameters,docs:{...(S=d.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    type: 'text',
...
}`,...(k=(F=i.parameters)==null?void 0:F.docs)==null?void 0:k.source}}};var C,L,f;p.parameters={...p.parameters,docs:{...(C=p.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: args => {
    const [text, setText] = useState('Sample text');
...
}`,...(f=(L=p.parameters)==null?void 0:L.docs)==null?void 0:f.source}}};var P,j,M;u.parameters={...u.parameters,docs:{...(P=u.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    type: 'text',
    label: 'Text Field Label',
    value: 'Sample text',
...
}`,...(M=(j=u.parameters)==null?void 0:j.docs)==null?void 0:M.source}}};var O,D,G;c.parameters={...c.parameters,docs:{...(O=c.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: args => {
...
}`,...(K=(J=g.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const se=["Default","Text","EditableText","EditableTextWithCopy","Masked","Password","PasswordWithCopy","Link","Checkbox","Dropdown"];export{b as Checkbox,n as Default,g as Dropdown,i as EditableText,p as EditableTextWithCopy,m as Link,u as Masked,c as Password,x as PasswordWithCopy,d as Text,se as __namedExportsOrder,re as default};
