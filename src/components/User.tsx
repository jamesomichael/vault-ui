...
const User = ({ name }: UserProps) => {
	return (
		<div className="group transition-all duration-200 hover:outline-2 hover:cursor-pointer outline-slate-800 hover:bg-slate-700 p-4 flex flex-col gap-4 md:gap-5 justify-center items-center text-white w-40 h-48 md:w-56 md:h-64 rounded-xl bg-slate-800">
